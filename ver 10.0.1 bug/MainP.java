                ...
                case "INTEGER":
                    ...
                    try{
                        ...
                        if(!isNumeric(codearr[x+2])){
                                ...
                                lineNumberErr(tempo); errctr=1;y=1;
                                run=false;                              
                        }
                        else{
                            x++;
                            for(int i=0;i<vp;i++){
                            System.out.println("V:"+variable[i]);
                        ...
                        if(h==false){
                            ...
                            codearr[x]= vp+"";
                            System.out.println("2"+codearr[x]);
                            System.out.println(variable[vp]);
                        }
                        }
...
//                            }
                                ...
                                codearr[x]=vp2+"";
                                System.out.println("0123:"+codearr[x]);
                            }
                            ...
                            x++;
                                for(int i=0;i<=vp;i++){
                                    System.out.println(codearr[x]);
                                    System.out.println("t"+variable[i]);
                                    if(codearr[x].equals(variable[i])){
                                        codearr[x]=i+"";
                                        i=vp;
                                        break;
                    ...
                    for(int i = 0;i<vp;i++){
                        if(codearr[x].equals(variable[i])){
                            System.out.println("B0:"+variable[i]);
                            System.out.println(codearr[x]);
                            codearr[x]=i+"";
                            i=vp+1;
                            System.out.println(codearr[x]); 
                    ...
                    if(codearr[x].equals("=")){
                        codearr[x]=1+"";
                            ...
                            for(int i=0;i<=vp;i++){
                            if(codearr[x].equals(variable[i])){
                            System.out.println("B1:"+variable[i]);
                            System.out.println(codearr[x]); 
                                codearr[x] = i+"";
                                i=vp+1;
                            System.out.println(codearr[x]); 
                            ...
                            System.out.println("ARITH: "+codearr[x]);
                    x++;
                    //integer checker
                            for(int i=0;i<=vp;i++){
                            if(codearr[x].equals(variable[i])){
                            System.out.println("B2:"+variable[i]);
                            System.out.println(codearr[x]); 
                                codearr[x] = i+"";
                                i=vp+1;
                            System.out.println(codearr[x]); 
...
//            System.out.println("l: "+variable[i]);
//            i++;
//        }
//        i=0;
        while(i<variable.length){
